...
- feat: Add self-healing loops with comprehensive test suite

## [0.1.12] - 2026-01-18

- fix(ci): Create release PRs instead of pushing directly to main
## [0.1.11] - 2026-01-18
...
- fix(cli): Add missing SessionMode type import

## [0.1.6] - 2026-01-18

- fix(ci): Handle Dependabot PRs in workflows

## [0.1.5] - 2026-01-18

- ci: Add comprehensive PR checks and security scanning

## [0.1.4] - 2026-01-18

- fix(ci): Rewrite auto-release to run on PRs
...
- Release automation and CI/CD improvements

## [0.1.1] - 2026-01-18

- CLI tool fixes and flowchart deployment

## [0.1.0] - 2026-01-18

- Initial release with Docker orchestration, 3-tier review system, and CLI

---

For detailed changes, see [docs/CHANGELOG-DETAILED.md](docs/CHANGELOG-DETAILED.md).
